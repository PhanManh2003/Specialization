...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/Cache$Entry$Companion;-><init>(Lqz/u/c/h;)V
...
.method public constructor <init>(Ltz/j0;)V
    ...
    check-cast v1, Ltz/d0;

    invoke-virtual {v1}, Ltz/d0;->P()Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(Ltz/l;)I
    ...
    invoke-static {v2}, Lsz/a/h/k;->a(Ljava/lang/String;)Lsz/a/h/k;

    move-result-object v2

    .line 10
    iget-object v3, v2, Lsz/a/h/k;->a:Lokhttp3/Protocol;

    iput-object v3, p0, Lokhttp3/Cache$Entry;->protocol:Lokhttp3/Protocol;

    .line 11
    iget v3, v2, Lsz/a/h/k;->b:I

    iput v3, p0, Lokhttp3/Cache$Entry;->code:I

    .line 12
    iget-object v2, v2, Lsz/a/h/k;->c:Ljava/lang/String;
    ...
    .line 28
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Ltz/l;)Ljava/util/List;
    ...
    .line 36
    :goto_4
    invoke-interface {p1}, Ltz/j0;->close()V
...
.method private final readCertificateList(Ltz/l;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Ltz/l;)I
    ...
    .line 5
    invoke-interface {p1}, Ltz/l;->P()Ljava/lang/String;
    ...
    .line 7
    sget-object v6, Ltz/n;->x:Ltz/m;

    invoke-virtual {v6, v4}, Ltz/m;->a(Ljava/lang/String;)Ltz/n;

    move-result-object v4

    invoke-static {v4}, Lqz/u/c/l;->e(Ljava/lang/Object;)V

    invoke-virtual {v5, v4}, Ltz/j;->H(Ltz/n;)Ltz/j;

    .line 8
    new-instance v4, Ltz/i;

    invoke-direct {v4, v5}, Ltz/i;-><init>(Ltz/j;)V
...
.method private final writeCertList(Ltz/k;Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Ltz/k;->L0(J)Ltz/k;
    ...
    invoke-static {v5, v4, v2, v2, v6}, Ltz/m;->d(Ltz/m;[BIII)Ltz/n;

    move-result-object v4

    invoke-virtual {v4}, Ltz/n;->a()Ljava/lang/String;

    move-result-object v4

    .line 5
    invoke-interface {p1, v4}, Ltz/k;->J0(Ljava/lang/String;)Ltz/k;

    move-result-object v4

    invoke-interface {v4, v1}, Ltz/k;->W(I)Ltz/k;
    :try_end_0
...
.method public final response(Lsz/a/e/j;)Lokhttp3/Response;
    .locals 5
    ...
    invoke-direct {v3, p1, v0, v1}, Lokhttp3/Cache$CacheResponseBody;-><init>(Lsz/a/e/j;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final writeTo(Lsz/a/e/g;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-virtual {p1, v0}, Lsz/a/e/g;->d(I)Ltz/h0;
    ...
    check-cast v2, Ltz/b0;

    invoke-virtual {v2, v1}, Ltz/b0;->J0(Ljava/lang/String;)Ltz/k;

    const/16 v1, 0xa

    invoke-virtual {v2, v1}, Ltz/b0;->W(I)Ltz/k;

    .line 3
    iget-object v3, p0, Lokhttp3/Cache$Entry;->requestMethod:Ljava/lang/String;

    invoke-virtual {v2, v3}, Ltz/b0;->J0(Ljava/lang/String;)Ltz/k;
    ...
    invoke-virtual {v2, v3, v4}, Ltz/b0;->L0(J)Ltz/k;
    ...
    invoke-virtual {v2, v6}, Ltz/b0;->J0(Ljava/lang/String;)Ltz/k;

    .line 7
    invoke-virtual {v2, v5}, Ltz/b0;->J0(Ljava/lang/String;)Ltz/k;
    ...
    invoke-direct {v3, v4, v6, v7}, Lsz/a/h/k;-><init>(Lokhttp3/Protocol;ILjava/lang/String;)V

    invoke-virtual {v3}, Lsz/a/h/k;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v2, v4}, Ltz/b0;->J0(Ljava/lang/String;)Ltz/k;
    ...
    invoke-virtual {v2, v0}, Ltz/b0;->J0(Ljava/lang/String;)Ltz/k;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Ltz/k;Ljava/util/List;)V
