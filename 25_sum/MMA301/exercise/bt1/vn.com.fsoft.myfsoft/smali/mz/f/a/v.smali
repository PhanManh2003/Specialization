...
.field public final synthetic u:Lmz/f/a/y;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lmz/f/a/y;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lmz/f/a/v;->t:Landroid/content/Context;

    iput-object p2, p0, Lmz/f/a/v;->u:Lmz/f/a/y;
...
.method public run()V
    ...
    :cond_1
    :try_start_2
    iget-object v2, p0, Lmz/f/a/v;->t:Landroid/content/Context;
    ...
    .line 12
    iget-object v0, p0, Lmz/f/a/v;->u:Lmz/f/a/y;

    const-string v2, "fb_sdk_initialize"

    const/4 v3, 0x0

    invoke-virtual {v0, v2, v3, v1}, Lmz/f/a/y;->g(Ljava/lang/String;Ljava/lang/Double;Landroid/os/Bundle;)V
    :try_end_2
