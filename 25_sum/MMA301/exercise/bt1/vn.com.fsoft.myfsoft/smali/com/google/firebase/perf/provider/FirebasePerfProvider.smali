...
# static fields
.field private static final APP_START_TIME:Lmz/h/d/d0/n/o;
...
.method public static constructor <clinit>()V
    ...
    .line 2
    sput-object v0, Lcom/google/firebase/perf/provider/FirebasePerfProvider;->APP_START_TIME:Lmz/h/d/d0/n/o;
...
.method public static getAppStartTime()Lmz/h/d/d0/n/o;
    .locals 1

    .line 1
    sget-object v0, Lcom/google/firebase/perf/provider/FirebasePerfProvider;->APP_START_TIME:Lmz/h/d/d0/n/o;
...
.method public attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    ...
    .line 7
    sget-object v0, Lmz/h/d/d0/g/d;->d:Lmz/h/d/d0/i/a;

    invoke-static {p2}, Lmz/h/d/d0/n/p;->a(Landroid/content/Context;)Z

    move-result v1

    .line 8
    iput-boolean v1, v0, Lmz/h/d/d0/i/a;->b:Z

    .line 9
    iget-object p1, p1, Lmz/h/d/d0/g/d;->c:Lmz/h/d/d0/g/y;

    invoke-virtual {p1, p2}, Lmz/h/d/d0/g/y;->b(Landroid/content/Context;)V
    ...
    .line 13
    :try_start_0
    iget-boolean v0, p1, Lmz/h/d/d0/f/a;->G:Z
    :try_end_0
    ...
    .line 18
    iput-boolean v1, p1, Lmz/h/d/d0/f/a;->G:Z
    :try_end_1
    ...
    .line 20
    :goto_0
    new-instance p2, Lmz/h/d/d0/d;

    invoke-direct {p2}, Lmz/h/d/d0/d;-><init>()V

    .line 21
    iget-object v0, p1, Lmz/h/d/d0/f/a;->w:Ljava/util/Set;

    monitor-enter v0

    .line 22
    :try_start_2
    iget-object p1, p1, Lmz/h/d/d0/f/a;->x:Ljava/util/Set;
    ...
    .line 24
    sget-object p1, Lcom/google/firebase/perf/metrics/AppStartTrace;->D:Lcom/google/firebase/perf/metrics/AppStartTrace;
    ...
    .line 26
    new-instance p2, Lmz/h/d/d0/n/a;

    invoke-direct {p2}, Lmz/h/d/d0/n/a;-><init>()V
    ...
    invoke-direct {v2, p1, p2}, Lcom/google/firebase/perf/metrics/AppStartTrace;-><init>(Lmz/h/d/d0/m/l;Lmz/h/d/d0/n/a;)V

    sput-object v2, Lcom/google/firebase/perf/metrics/AppStartTrace;->D:Lcom/google/firebase/perf/metrics/AppStartTrace;
    ...
    .line 35
    :try_start_4
    iget-boolean v0, p1, Lcom/google/firebase/perf/metrics/AppStartTrace;->t:Z
    :try_end_4
    ...
    .line 40
    iput-boolean v1, p1, Lcom/google/firebase/perf/metrics/AppStartTrace;->t:Z

    .line 41
    iput-object p2, p1, Lcom/google/firebase/perf/metrics/AppStartTrace;->w:Landroid/content/Context;
    :try_end_5
    ...
    sget-object p2, Lmz/h/d/d0/o/m;->FOREGROUND:Lmz/h/d/d0/o/m;

    invoke-virtual {p1, p2}, Lcom/google/firebase/perf/session/SessionManager;->updatePerfSession(Lmz/h/d/d0/o/m;)V
