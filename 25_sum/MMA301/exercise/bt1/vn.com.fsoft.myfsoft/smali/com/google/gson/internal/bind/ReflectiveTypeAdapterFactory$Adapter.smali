...
# instance fields
.field public final a:Lmz/h/e/z/a0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lmz/h/e/z/a0<",
            "TT;>;"
...
# direct methods
.method public constructor <init>(Lmz/h/e/z/a0;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->a:Lmz/h/e/z/a0;
...
.method public read(Lmz/h/e/b0/b;)Ljava/lang/Object;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lcom/google/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->a:Lmz/h/e/z/a0;
    ...
    .line 9
    :cond_2
    check-cast v1, Lmz/h/e/z/h0/e;

    .line 10
    iget-object v2, v1, Lmz/h/e/z/h0/e;->f:Lcom/google/gson/TypeAdapter;
    ...
    .line 11
    iget-boolean v3, v1, Lmz/h/e/z/h0/e;->i:Z

    if-nez v3, :cond_1

    .line 12
    :cond_3
    iget-object v1, v1, Lmz/h/e/z/h0/e;->d:Ljava/lang/reflect/Field;
    ...
    :cond_4
    :goto_1
    invoke-virtual {p1}, Lmz/h/e/b0/b;->a0()V
    :try_end_0
...
.method public write(Lmz/h/e/b0/d;Ljava/lang/Object;)V
    ...
    .line 6
    :cond_2
    iget-object v2, v2, Lmz/h/e/z/h0/e;->d:Ljava/lang/reflect/Field;
    ...
    invoke-virtual {p1, v2}, Lmz/h/e/b0/d;->k(Ljava/lang/String;)Lmz/h/e/b0/d;

    .line 8
    check-cast v1, Lmz/h/e/z/h0/e;

    .line 9
    iget-object v2, v1, Lmz/h/e/z/h0/e;->d:Ljava/lang/reflect/Field;
    ...
    .line 10
    iget-boolean v3, v1, Lmz/h/e/z/h0/e;->e:Z

    if-eqz v3, :cond_4

    iget-object v1, v1, Lmz/h/e/z/h0/e;->f:Lcom/google/gson/TypeAdapter;
    ...
    iget-object v4, v1, Lmz/h/e/z/h0/e;->g:Lcom/google/gson/Gson;

    iget-object v5, v1, Lmz/h/e/z/h0/e;->f:Lcom/google/gson/TypeAdapter;

    iget-object v1, v1, Lmz/h/e/z/h0/e;->h:Lmz/h/e/a0/a;
    ...
    .line 13
    :goto_2
    invoke-virtual {v1, p1, v2}, Lcom/google/gson/TypeAdapter;->write(Lmz/h/e/b0/d;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_0} :catch_0
