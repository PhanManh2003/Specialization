...
@WebServlet(name = "CancelOfferController", urlPatterns = {"/cancelOffer"})
public class CancelOfferController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean success = cancelOffer(request, response, offerID);
    ...
    private boolean cancelOffer(HttpServletRequest request, HttpServletResponse response, int offerID) {
        // Khởi tạo DAO
        ...
        boolean offerUpdated = offerDAO.updateOfferStatus(offerID, "Cancelled offer");
        ...
        if (offerUpdated) {
            ...
            if (offer != null && schedule != null) {
                ...
                boolean jobAppUpdated = applicationDAO.updateStatus(schedule.getJobID(), 
                        offer.getCandidateID(), "Cancelled offer");
