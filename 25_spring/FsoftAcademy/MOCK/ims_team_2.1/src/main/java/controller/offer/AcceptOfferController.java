...
@WebServlet(name = "AcceptOfferController", urlPatterns = {"/acceptOffer"})
public class AcceptOfferController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean success = acceptOffer(request, response, offerID);
    ...
    private boolean acceptOffer(HttpServletRequest request, HttpServletResponse response, int offerID) {
        // Khởi tạo DAO
        ...
        boolean offerUpdated = offerDAO.updateOfferStatus(offerID, "Accepted");
        ...
        if (offerUpdated) {
            ...
            if (offer != null && schedule != null) {
                ...
                boolean jobAppUpdated = applicationDAO.updateStatus(schedule.getJobID(),
                        offer.getCandidateID(), "Accepted offer");
