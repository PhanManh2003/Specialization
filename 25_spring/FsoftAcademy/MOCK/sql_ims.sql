...
CREATE TABLE Schedule (
	...
	CONSTRAINT UQ_Schedule_Job_Candidate UNIQUE (JobID, CandidateID)
);
GO
...
SELECT * FROM dbo.Job -- Open: 2,4,5,6,8,9,10,11,13,14
SELECT * FROM dbo.UserAccount
-- update job
...
(1, 2, '2025-03-01 10:15:00', 'Waiting for interview'),
(2, 2, '2025-03-02 11:00:00', 'In-progress'),
(3, 2, '2025-03-03 09:45:00', 'Cancelled'),
(4, 4, '2025-03-04 14:30:00', 'Failed interview'),
(5, 4, '2025-03-05 13:10:00', 'Passed interview'),
(6, 5, '2025-03-06 15:20:00', 'Waiting for approval'),
(7, 5, '2025-03-07 16:00:00', 'Approved offer'),
(8, 6, '2025-03-08 10:00:00', 'Rejected offer'),
(9, 6, '2025-03-09 12:15:00', 'Waiting for response'),
(10, 8, '2025-03-10 17:00:00', 'Cancelled offer'),
(11, 9, '2025-03-11 09:30:00', 'Accepted offer'),
(12, 10, '2025-03-12 10:45:00', 'Denied offer'),
(13, 11, '2025-03-13 14:00:00', 'Waiting for interview'),
(14, 13, '2025-03-14 11:30:00', 'Waiting for interview'),
(15, 14, '2025-03-15 13:50:00', 'Passed interview');

SELECT * FROM dbo.JobApplication
SELECT * FROM dbo.Job -- Open: 2,4,5,6,8,9,10,11,13,14
SELECT * FROM dbo.Candidate
SELECT * FROM dbo.UserAccount -- Interviewer : 2,6,8,10,12,14,18,20,22,24,26,28,30
SELECT * FROM dbo.Schedule
...
VALUES
(6, 9, 2, 1, 'Technical Round 1', 'Qualified', '2025-03-30 09:00:00', '2025-03-30 10:30:00', 'Room 201', 'https://meet.google.com/nvn-qjdk-jmb', 'Candidate ok with problem-solving')
(2, 1, 2, 1, 'Technical Round 1', 'Failed', '2025-03-30 09:00:00', '2025-03-30 10:30:00', 'Room 201', 'https://meet.google.com/nvn-qjdk-jmb', 'Candidate struggled with problem-solving'),
(2, 2, 2, 1, 'HR Discussion', 'Qualified', '2025-03-31 11:00:00', '2025-03-31 12:00:00', 'Online via Teams', 'https://meet.google.com/nvn-qjdk-jmb', 'Discuss career goals & experience'),
(2, 3, 2, 1, 'Final Decision Meeting', 'Pending', '2025-04-01 14:30:00', '2025-04-01 16:00:00', 'Conference Hall', 'https://meet.google.com/nvn-qjdk-jmb', 'Review overall performance'),
(4, 4, 2, 4, 'Initial Screening', 'Pending', '2025-04-02 10:00:00', '2025-04-02 11:30:00', 'Google Meet', 'https://meet.google.com/nvn-qjdk-jmb', 'Assess skills and experience'),
(4, 5, 2, 4, 'Second Technical Interview', 'Failed', '2025-04-03 13:00:00', '2025-04-03 14:30:00', 'Zoom Online', 'https://meet.google.com/nvn-qjdk-jmb', 'Candidate lacked required experience'),
(5, 6, 6, 4, 'Behavioral Interview', 'Qualified', '2025-04-04 15:00:00', '2025-04-04 16:00:00', 'Office Room C', 'https://meet.google.com/nvn-qjdk-jmb', 'Candidate showed strong teamwork skills'),
(5, 7, 6, 7, 'Final Round Interview', 'Pending', '2025-04-05 09:30:00', '2025-04-05 10:30:00', 'Teams Online', 'https://meet.google.com/nvn-qjdk-jmb', 'Decision to be made after this round'),
(6, 8, 6, 7, 'Salary Negotiation', 'Pending', '2025-04-06 14:00:00', '2025-04-06 15:30:00', 'HR Office', 'https://meet.google.com/nvn-qjdk-jmb', 'Discuss final offer details'),
(8, 10, 10, 7, 'Final Evaluation', 'Failed', '2025-04-07 11:00:00', '2025-04-07 12:30:00', 'Main Office', 'https://meet.google.com/nvn-qjdk-jmb', 'Candidate did not meet requirements'),
(9, 11, 10, 11, 'Closing Interview', 'Pending', '2025-04-08 10:00:00', '2025-04-08 11:30:00', 'Online Zoom', 'https://meet.google.com/nvn-qjdk-jmb', 'Final decision pending');
SELECT * FROM dbo.Schedule -- id từ 12-21
...
SELECT * FROM dbo.Candidate
SELECT * FROM dbo.Schedule
select distinct position  from dbo.Candidate

/*
CHECK (Status IN (
        'Waiting for interview', 'In-progress', 'Cancelled'(cancel schedule), 
        'Failed interview', 'Passed interview', 'Waiting for approval',
        'Approved offer', 'Rejected offer', 'Waiting for response', 
        'Cancelled offer', 'Accepted offer', 'Denied offer'
    )),
...
select distinct j.*  from dbo.Job j 
inner join dbo.JobApplication ja on j.JobID = ja.JobID where ja.Status = 'Waiting for interview';

select distinct c.*  from dbo.Candidate c 
inner join dbo.JobApplication ja on c.CandidateID = ja.CandidateID where ja.Status = 'Waiting for interview'
...
select * from dbo.Job
select * from dbo.JobApplication
Update dbo.JobApplication set Status = 'Passed interview' where jobID =14 and CandidateID =15  --c15 j14
delete from dbo.Schedule where ScheduleID = 40
select * from dbo.Offer
delete from dbo.Offer where OfferID = 14
select * from dbo.UserAccount -- manager là 3,7,11,15,19,23,27

-- INSERT OFFER ----
INSERT INTO Offer (
    ScheduleID, CandidateID, ApprovedBy, ContractType, Position, Level, Department, 
    CreatedBy, ContractStartFrom, ContractTo, BasicSalary, Status, OfferNotes
)
VALUES
-- JobID 5, CandidateID 7, Approved offer
(18, 7, 3, 'FullTime', 'Frontend Developer', 'Mid', 'IT', 1, 
 '2025-04-15', '2026-04-15', 2000.00, 'Approved', 'Offer approved after final round'),

-- JobID 6, CandidateID 8, Rejected offer
(19, 8, 7, 'PartTime', 'Backend Developer', 'Fresher', 'IT', 4, 
 '2025-04-20', '2026-04-20', 1800.00, 'Rejected', 'Candidate rejected the salary offer'),

-- JobID 8, CandidateID 10, Cancelled offer
(20, 10, 11, 'PartTime', 'HR Specialist', 'Mid', 'HR', 3, 
 '2025-04-25', '2025-10-25', 1500.00, 'Cancelled offer', 'Offer cancelled due to budget cuts'),

-- JobID 9, CandidateID 11, Accepted offer
(21, 11, 15, 'FullTime', 'DevOps Engineer', 'Mid', 'IT', 4, 
 '2025-05-01', '2026-05-01', 2500.00, 'Accepted', 'Candidate accepted after negotiation');
 -- JobID 9, CandidateID 11, Accepted offer

-- JobID 10, CandidateID 12 không có ScheduleID nên không insert được, trừ khi thêm Schedule trước
...
VALUES (32, 9, 3, 'FullTime', 'DevOps Engineer', 'Mid', 'IT', 4, 
 '2025-05-01', '2026-05-01', 2500.00, 'Waiting for response', 'Candidate accepted after negotiation');



--ALTER TABLE Schedule
--ADD CONSTRAINT UQ_Schedule_Job_Candidate UNIQUE (JobID, CandidateID);

select * from dbo.Schedule
select * from dbo.JobApplication 
update dbo.JobApplication SET Status = 'Passed interview' where candidateID = 15 and jobID = 14
update dbo.Schedule set Status = 'Qualified' where ScheduleID = 31
select * from dbo.offer 
update dbo.Offer set Status = 'Approved' where OfferID = 12
select * from dbo.Candidate



/*
cần trigger vì nếu chỉ check trong DAO thôi  thì sẽ dính race condition khi insert, ví dụ:
T: Hàm insertApplication kiểm tra Status của Candidate (lúc này là 'Open').
T+0.1s: Admin ban Candidate, cập nhật Status thành 'Banned'.
T+0.2s: Hàm insertApplication thực hiện INSERT, thêm Application thành công mặc dù Candidate đã bị banned.

CREATE TRIGGER PreventApplicationForBannedCandidate
ON dbo.JobApplication
INSTEAD OF INSERT
AS
BEGIN
    IF EXISTS (
        SELECT 1
        FROM inserted i
        JOIN dbo.Candidate c ON i.CandidateID = c.CandidateID
        WHERE c.Status = 'Banned'
    )
    BEGIN
        RAISERROR ('Cannot insert application for a banned candidate.', 16, 1);
        ROLLBACK;
    END
    ELSE
    BEGIN
        INSERT INTO dbo.JobApplication (CandidateID, JobID, ApplicationDate, Status)
        SELECT CandidateID, JobID, ApplicationDate, Status
        FROM inserted;
    END
END;


--2. Khi banned candidate thì xoá luôn các application , schedule, offer liên quan.
*/